    ...
    <>
        <div className="space-y-4">
            <div className="border rounded-md">
                <p className="py-2 px-3">{issueDetails.assignee || "Unassigned"}</p>
            </div>
            {project.projectDetails?.team.map((item)=><div key={item} className="py-2 group hover:bg-slate-800 cursor-pointer flex
